...
const SignUp = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 sm:py-12 md:py-9">
      <form className="max-w-xl w-screen mx-auto px-4 py-6 md:p-8 rounded-2xl bg-gradient-to-br from-zinc-900 to-black shadow-lg border border-zinc-700 space-y-5 backdrop-blur-sm">
        {/* Title */}
        <section>
